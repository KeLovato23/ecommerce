                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return 'Porfavor selecciones categoria';
                                      }
                                      return null;
                                    },
                                    //keyboardType: TextInputType.emailAddress,
                                    decoration: InputDecoration(
                                      labelText: 'Agregar nuevo producto',
                                    ),
                                    onSaved: (value) {
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return 'Se echa de menos la marca';
                                      }
                                      return null;
                                    },
                                    //keyboardType: TextInputType.emailAddress,
                        ...
                        TextFormField(
                            ...
                            validator: (value) {
                              if (value.isEmpty) {
                                return 'se requiere descripción del producto';
                              }
                              return null;
                            },
