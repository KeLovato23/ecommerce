...
class Products with ChangeNotifier {
  List<Product> _products = [
    Product(
        ...
        description:
            'Samsung Galaxy S9 G960U 64GB Teléfono GSM 4G LTE desbloqueado con cámara de 12MP - Negro medianoche.',
        price: 50.99,
        imageUrl:
            'https://images-na.ssl-images-amazon.com/images/I/81%2Bh9mpyQmL._AC_SL1500_.jpg',
        brand: 'Samsung',
        productCategoryName: 'celulares',
        quantity: 65,
        isPopular: false),
    Product(
        ...
        description:
            'Samsung Galaxy A10s A107M - 32GB, 6.2 "HD + Pantalla Infinity-V, 13MP + 2MP Dual Rear + 8MP Front Cameras, GSM Unlocked Smartphone - Azul.',
        price: 50.99,
        imageUrl:
    ...
    Product(
        ...
        description:
            'Samsung Galaxy A51 (128GB, 4GB) 6.5 ", 48MP Quad Camera, Dual SIM GSM desbloqueado A515F / DS - Global 4G LTE International Model - Prism Crush Blue.',
        price: 50.99,
        imageUrl:
    ...
    Product(
        ...
        description:
            'Huawei P40 Pro (5G) ELS-NX9 Dual / Hybrid-SIM 256GB (GSM solamente | Sin CDMA) Smartphone desbloqueado de fábrica (Silver Frost) - Versión internacional',
        price: 900.99,
        imageUrl:
    ...
    Product(
        ...
        title: 'iPhone 12 Pro',
        description:
            'Nuevo Apple iPhone 12 Pro (512 GB, dorado) [bloqueado] + suscripción de operador',
        price: 1100,
    ...
    Product(
        ...
        description:
            'Nuevo Apple iPhone 12 Pro Max (128 GB, grafito) [bloqueado] + suscripción de operador',
        price: 50.99,
        imageUrl:
    ...
    Product(
        id: 'Hanes Mens ',
        title: 'Camiseta henley de manga larga',
        description: 'Hombres Hanes\'s Camiseta henley de manga larga',
        price: 22.30,
        imageUrl:
    ...
    Product(
        id: 'Weave Jogger',
        title: 'Weave Jogger',
        description: 'Champion Jogger de tejido inverso para hombre',
        price: 58.99,
        imageUrl:
